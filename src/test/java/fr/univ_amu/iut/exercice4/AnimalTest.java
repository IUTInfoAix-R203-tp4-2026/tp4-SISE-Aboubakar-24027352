...
class AnimalTest {
  ...
  // @Disabled("Activer après Replace Conditional with Polymorphism (Animal
  // devient abstract)")
  @Test
  ...
  // @Disabled("Activer après avoir créé les classes Chat, Vache, Canard extends
  // Animal")
  @Test
  ...
  // @Disabled("Activer après avoir créé une méthode statique de fabrique
  // (Animal.creer(type, nom))")
  @Test
